...
class MxpDevTools {
	...
	public function init() {
		...
		if (is_multisite()) {
			add_action('network_admin_menu', array($this, 'create_plugin_menu'));
		} else {
	...
	public function wpdboptimizemethods_page_cb() {
		$this->page_wraper('WordPress 資料庫最佳化相關功能', function () {
			...
			$user_metabox_count = $wpdb->get_var("SELECT COUNT(umeta_id) FROM {$wpdb->base_prefix}usermeta WHERE meta_key LIKE 'meta-box-order_%'");
