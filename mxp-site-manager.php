...
class MDTSiteManager {
	...
	public function admin_menu() {
		...
		if (apply_filters('mxp_dev_overwrite_site_manager_display', $display)) {
			add_management_page(
				'Site Manager',
				'Site Manager',
				apply_filters('mxp_dev_overwrite_site_manager_cap', 'manage_options'),
				'mxp-site-manager',
				array(
					$this,
					'settings_page',
	...
	public function network_admin_menu() {
		...
		if (apply_filters('mxp_dev_overwrite_site_manager_mu_display', $display)) {
			add_menu_page('Site Manager', 'Site Manager', apply_filters('mxp_dev_overwrite_site_manager_mu_cap', 'administrator'), $this->plugin_slug, array($this, 'settings_page'), 'dashicons-admin-generic');
		}
	}
	...
	public function ajax_action() {
		...
		if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'mxp-ajax-nonce-for-site-manager-dashboard')) {
